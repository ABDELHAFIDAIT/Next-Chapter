    ...
    <main class="flex">
        ...
        <nav class="flex flex-col justify-between h-screen bg-[#222222] text-white p-4 w-56">
            ...
            <div class="flex flex-col gap-2 text-xs">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 p-3 hover:bg-[#D6FF40] hover:text-black rounded-lg transition-all ease-in-out duration-300 rounded-lg bg-[#D6FF40] text-black">
