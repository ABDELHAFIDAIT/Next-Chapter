        ...
        <header class="px-20">
            ...
            <nav class="flex items-center justify-between py-10">
                ...
                <div id="menu"
                    ...
                    <a href="{{ route('prisonner.applications') }}" class="px-5 flex items-center gap-3 hover:bg-[#D6FF40] hover:text-[#222222] py-3 border-b border-b-[#303030] transition-all ease-in-out duration-300">
